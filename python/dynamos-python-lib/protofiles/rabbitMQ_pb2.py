...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SIDECARMESSAGE_TRACESENTRY']._loaded_options = None
  _globals['_SIDECARMESSAGE_TRACESENTRY']._serialized_options = b'8\001'
  _globals['_USERARCHETYPES_ARCHETYPESENTRY']._loaded_options = None
  _globals['_USERARCHETYPES_ARCHETYPESENTRY']._serialized_options = b'8\001'
  _globals['_VALIDATIONRESPONSE_VALIDDATAPROVIDERSENTRY']._loaded_options = None
  _globals['_VALIDATIONRESPONSE_VALIDDATAPROVIDERSENTRY']._serialized_options = b'8\001'
  _globals['_VALIDATIONRESPONSE_OPTIONSENTRY']._loaded_options = None
  _globals['_VALIDATIONRESPONSE_OPTIONSENTRY']._serialized_options = b'8\001'
  _globals['_REQUESTAPPROVAL_OPTIONSENTRY']._loaded_options = None
  _globals['_REQUESTAPPROVAL_OPTIONSENTRY']._serialized_options = b'8\001'
  _globals['_REQUESTAPPROVALRESPONSE_AUTHORIZEDPROVIDERSENTRY']._loaded_options = None
  _globals['_REQUESTAPPROVALRESPONSE_AUTHORIZEDPROVIDERSENTRY']._serialized_options = b'8\001'
  _globals['_SQLDATAREQUEST_ALGORITHMCOLUMNSENTRY']._loaded_options = None
  _globals['_SQLDATAREQUEST_ALGORITHMCOLUMNSENTRY']._serialized_options = b'8\001'
  _globals['_SQLDATAREQUEST_OPTIONSENTRY']._loaded_options = None
  _globals['_SQLDATAREQUEST_OPTIONSENTRY']._serialized_options = b'8\001'
