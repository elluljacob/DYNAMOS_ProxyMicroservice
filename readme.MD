...
### Other Issues
For other issues, first try looking at Troubleshooting.md

# Cloud Integration

## 15. Snowflake Integration (ext-provider)

This repository includes `ext-provider`, a proxy microservice that integrates 
DYNAMOS with Snowflake as a policy-compliant cloud agent. See the dedicated 
documentation:

- [ext-provider setup and configuration](./configuration/ext-provider/Readme.md)
- [Policy format reference](./configuration/ext-provider/Policy.md)
